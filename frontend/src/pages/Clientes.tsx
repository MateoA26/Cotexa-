...
export default function Clientes() {
  ...
  const ic = "w-full h-9 px-3 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sky-500"
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
            ...
            <div className="flex gap-2 mt-5">
              ...
              <button onClick={() => mutation.mutate()} disabled={!form.nombre || mutation.isPending}
                className="flex-1 h-10 bg-sky-600 hover:bg-sky-700 text-white rounded-lg text-sm font-medium transition-colors disabled:opacity-40">
