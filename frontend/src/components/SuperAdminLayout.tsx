    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <aside className={
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white text-[13px] font-bold leading-none">Cotexa</p>
              <p className="text-sky-400 text-[10px] font-semibold mt-0.5">SuperAdmin</p>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        <header className="md:hidden flex items-center gap-3 px-4 py-3 flex-shrink-0 border-b border-slate-200 bg-white">
          ...
          <span className="text-slate-800 text-sm font-bold">SuperAdmin</span>
        </header>
